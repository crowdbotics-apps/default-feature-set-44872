...
## Project Structure
    ...
    ├── default_feature_set_44872  # Django project configurations
...
1. Clone this repo and `cd default_feature_set_44872`
...
2. Clone this repo and `cd default_feature_set_44872`
